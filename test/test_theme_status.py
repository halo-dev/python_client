...
class TestThemeStatus(unittest.TestCase):
    """ThemeStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThemeStatus:
        """Test ThemeStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThemeStatus`
        """
        model = ThemeStatus()
        if include_optional:
            return ThemeStatus(
