...
class TestSinglePageStatus(unittest.TestCase):
    """SinglePageStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SinglePageStatus:
        """Test SinglePageStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SinglePageStatus`
        """
        model = SinglePageStatus()
        if include_optional:
            return SinglePageStatus(
                comments_count = 56,
                conditions = [
