...
class TestListedSinglePageVoList(unittest.TestCase):
    """ListedSinglePageVoList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListedSinglePageVoList:
        """Test ListedSinglePageVoList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListedSinglePageVoList`
        """
        model = ListedSinglePageVoList()
        if include_optional:
            return ListedSinglePageVoList(
                ...
                has_previous = True,
                items = [
                    halo_client.models.listed_single_page_vo.ListedSinglePageVo(
                        contributors = [
    ...
    def testListedSinglePageVoList(self):
        """Test ListedSinglePageVoList"""
