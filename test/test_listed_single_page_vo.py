...
class TestListedSinglePageVo(unittest.TestCase):
    """ListedSinglePageVo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListedSinglePageVo:
        """Test ListedSinglePageVo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListedSinglePageVo`
        """
        model = ListedSinglePageVo()
        if include_optional:
            return ListedSinglePageVo(
                contributors = [
    ...
    def testListedSinglePageVo(self):
        """Test ListedSinglePageVo"""
