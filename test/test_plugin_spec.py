...
class TestPluginSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PluginSpec:
        """Test PluginSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginSpec`
        """
        model = PluginSpec()
        if include_optional:
            return PluginSpec(
