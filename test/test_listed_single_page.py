...
class TestListedSinglePage(unittest.TestCase):
    """ListedSinglePage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListedSinglePage:
        """Test ListedSinglePage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListedSinglePage`
        """
        model = ListedSinglePage()
        if include_optional:
