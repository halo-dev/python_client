...
class TestSinglePageRequest(unittest.TestCase):
    """SinglePageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SinglePageRequest:
        """Test SinglePageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SinglePageRequest`
        """
        model = SinglePageRequest()
        if include_optional:
            return SinglePageRequest(
                content = halo_client.models.content_update_param.ContentUpdateParam(
                    content = '', 
                    raw = '', 
                    raw_type = '', 
                    version = 56, ),
    ...
    def testSinglePageRequest(self):
        """Test SinglePageRequest"""
