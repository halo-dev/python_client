...
class TestSinglePageList(unittest.TestCase):
    """SinglePageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SinglePageList:
        """Test SinglePageList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SinglePageList`
        """
        model = SinglePageList()
        if include_optional:
            return SinglePageList(
                ...
                has_previous = True,
                items = [
                    halo_client.models.single_page.SinglePage(
                        api_version = '', 
                        kind = '', 
