...
class TestThemeList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThemeList:
        """Test ThemeList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThemeList`
        """
        model = ThemeList()
        if include_optional:
            return ThemeList(
                ...
                has_previous = True,
                items = [
                    halo_client.models.theme.Theme(
                        api_version = '', 
                        kind = '', 
