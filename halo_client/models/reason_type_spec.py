...
class ReasonTypeSpec(BaseModel):
    """
    ReasonTypeSpec
    """ # noqa: E501
    ...
    properties: Optional[List[ReasonProperty]] = None
    __properties: ClassVar[List[str]] = ["description", "displayName", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [ReasonProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
