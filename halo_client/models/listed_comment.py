...
class ListedComment(BaseModel):
    ...
    owner: OwnerInfo
    stats: CommentStats
    subject: Optional[Extension] = None
    __properties: ClassVar[List[str]] = ["comment", "owner", "stats", "subject"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subject": Extension.from_dict(obj["subject"]) if obj.get("subject") is not None else None
        })
        return _obj
