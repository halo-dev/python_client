...
class NotifierDescriptor(BaseModel):
    """
    ...
    kind: StrictStr
    metadata: Metadata
    spec: Optional[NotifierDescriptorSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": NotifierDescriptorSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
