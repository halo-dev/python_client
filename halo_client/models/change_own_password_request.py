...
class ChangeOwnPasswordRequest(BaseModel):
    ...
    """ # noqa: E501
    old_password: StrictStr = Field(description="Old password.", alias="oldPassword")
    password: Annotated[str, Field(min_length=5, strict=True)] = Field(description="New password.")
