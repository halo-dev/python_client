...
class RoleBinding(BaseModel):
    ...
    kind: StrictStr
    metadata: Metadata
    role_ref: Optional[RoleRef] = Field(default=None, alias="roleRef")
    subjects: Optional[List[Subject]] = Field(default=None, description="Subjects holds references to the objects the role applies to.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roleRef": RoleRef.from_dict(obj["roleRef"]) if obj.get("roleRef") is not None else None,
