...
class ListedSinglePage(BaseModel):
    """
    A chunk of items.
    """ # noqa: E501
    ...
    page: SinglePage
    stats: Stats
    __properties: ClassVar[List[str]] = ["contributors", "owner", "page", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": Contributor.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "page": SinglePage.from_dict(obj["page"]) if obj.get("page") is not None else None,
