...
class Secret(BaseModel):
    ...
    data: Optional[Dict[str, Union[StrictBytes, StrictStr]]] = Field(default=None, description="<p>The total bytes of the values in  the Data field must be less than {@link run.halo.app.extension.Secret#MAX_SECRET_SIZE #MAX_SECRET_SIZE} bytes.</p>  <p><code>data</code> contains the secret data. Each key must consist of alphanumeric  characters, '-', '_' or '.'. The serialized form of the secret data is a  base64 encoded string, representing the arbitrary (possibly non-string)  data value here. Described in  <a href=\"https://tools.ietf.org/html/rfc4648#section-4\">rfc4648#section-4</a>  </p>")
    kind: StrictStr
    metadata: Metadata
    string_data: Optional[Dict[str, StrictStr]] = Field(default=None, description="<code>stringData</code> allows specifying non-binary secret data in string form.  It is provided as a write-only input field for convenience.  All keys and values are merged into the data field on write, overwriting any existing  values.  The stringData field is never output when reading from the API.", alias="stringData")
    type: Optional[StrictStr] = Field(default=None, description="Used to facilitate programmatic handling of secret data.  More info:  <a href=\"https://kubernetes.io/docs/concepts/configuration/secret/#secret-types\">secret-types</a>")
    __properties: ClassVar[List[str]] = ["apiVersion", "data", "kind", "metadata", "stringData", "type"]
