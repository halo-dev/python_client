...
class PolicyRule(BaseModel):
    ...
    """ # noqa: E501
    api_groups: Optional[List[StrictStr]] = Field(default=None, description="APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated  resources in any API group will be allowed.", alias="apiGroups")
    ...
    resources: Optional[List[StrictStr]] = Field(default=None, description="Resources is a list of resources this rule applies to.  '*' represents all resources in  the specified apiGroups.  '*&#47;foo' represents the subresource 'foo' for all resources in the specified  apiGroups.")
    verbs: Optional[List[StrictStr]] = Field(default=None, description="about who the rule applies to or which namespace the rule applies to.")
