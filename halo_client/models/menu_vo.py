...
class MenuVo(BaseModel):
    ...
    """ # noqa: E501
    menu_items: Optional[List[MenuItemVo]] = Field(default=None, alias="menuItems")
    metadata: Metadata
    spec: Optional[MenuSpec] = None
    __properties: ClassVar[List[str]] = ["menuItems", "metadata", "spec"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "menuItems": [MenuItemVo.from_dict(_item) for _item in obj["menuItems"]] if obj.get("menuItems") is not None else None,
            "metadata": Metadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "spec": MenuSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
