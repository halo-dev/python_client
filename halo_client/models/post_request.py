...
class PostRequest(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[ContentUpdateParam] = None
    post: Post
    __properties: ClassVar[List[str]] = ["content", "post"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": ContentUpdateParam.from_dict(obj["content"]) if obj.get("content") is not None else None,
