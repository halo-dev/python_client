...
class NavigationPostVo(BaseModel):
    """
    Post navigation vo to hold previous and next item.
    """ # noqa: E501
    current: Optional[PostVo] = None
    next: Optional[PostVo] = None
    previous: Optional[PostVo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": PostVo.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "next": PostVo.from_dict(obj["next"]) if obj.get("next") is not None else None,
            "previous": PostVo.from_dict(obj["previous"]) if obj.get("previous") is not None else None
        })
        return _obj
