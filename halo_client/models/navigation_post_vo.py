...
class NavigationPostVo(BaseModel):
    ...
    """ # noqa: E501
    next: Optional[ListedPostVo] = None
    previous: Optional[ListedPostVo] = None
    __properties: ClassVar[List[str]] = ["next", "previous"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "next": ListedPostVo.from_dict(obj["next"]) if obj.get("next") is not None else None,
            "previous": ListedPostVo.from_dict(obj["previous"]) if obj.get("previous") is not None else None
        })
        return _obj
