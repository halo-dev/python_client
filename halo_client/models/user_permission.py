...
class UserPermission(BaseModel):
    ...
    roles: List[Role]
    ui_permissions: List[StrictStr] = Field(alias="uiPermissions")
    __properties: ClassVar[List[str]] = ["permissions", "roles", "uiPermissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [Role.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
            "roles": [Role.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
            "uiPermissions": obj.get("uiPermissions")
        })
        return _obj
