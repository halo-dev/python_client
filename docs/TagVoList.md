...
**items** | [**List[TagVo]**](TagVo.md) | A chunk of items. | 
...
json = "{}"
# create an instance of TagVoList from a JSON string
tag_vo_list_instance = TagVoList.from_json(json)
# print the JSON string representation of the object
print(TagVoList.to_json())

# convert the object into a dict
tag_vo_list_dict = tag_vo_list_instance.to_dict()
# create an instance of TagVoList from a dict
tag_vo_list_from_dict = TagVoList.from_dict(tag_vo_list_dict)
```
