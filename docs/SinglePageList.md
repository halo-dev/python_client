...
**items** | [**List[SinglePage]**](SinglePage.md) | A chunk of items. | 
...
json = "{}"
# create an instance of SinglePageList from a JSON string
single_page_list_instance = SinglePageList.from_json(json)
# print the JSON string representation of the object
print(SinglePageList.to_json())

# convert the object into a dict
single_page_list_dict = single_page_list_instance.to_dict()
# create an instance of SinglePageList from a dict
single_page_list_from_dict = SinglePageList.from_dict(single_page_list_dict)
```
