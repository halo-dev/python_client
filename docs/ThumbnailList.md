...
**items** | [**List[Thumbnail]**](Thumbnail.md) | A chunk of items. | 
...
thumbnail_list_instance = ThumbnailList.from_json(json)
# print the JSON string representation of the object
print(ThumbnailList.to_json())

# convert the object into a dict
thumbnail_list_dict = thumbnail_list_instance.to_dict()
# create an instance of ThumbnailList from a dict
thumbnail_list_from_dict = ThumbnailList.from_dict(thumbnail_list_dict)
```
