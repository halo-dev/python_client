...
**items** | [**List[RoleBinding]**](RoleBinding.md) | A chunk of items. | 
...
json = "{}"
# create an instance of RoleBindingList from a JSON string
role_binding_list_instance = RoleBindingList.from_json(json)
# print the JSON string representation of the object
print(RoleBindingList.to_json())

# convert the object into a dict
role_binding_list_dict = role_binding_list_instance.to_dict()
# create an instance of RoleBindingList from a dict
role_binding_list_from_dict = RoleBindingList.from_dict(role_binding_list_dict)
```
