...
------------- | ------------- | -------------
[**create_comment**](CommentV1alpha1ConsoleApi.md#create_comment) | **POST** /apis/api.console.halo.run/v1alpha1/comments | 
[**create_reply**](CommentV1alpha1ConsoleApi.md#create_reply) | **POST** /apis/api.console.halo.run/v1alpha1/comments/{name}/reply | 
[**list_comments**](CommentV1alpha1ConsoleApi.md#list_comments) | **GET** /apis/api.console.halo.run/v1alpha1/comments | 
