...
**items** | [**List[ListedPost]**](ListedPost.md) | A chunk of items. | 
...
json = "{}"
# create an instance of ListedPostList from a JSON string
listed_post_list_instance = ListedPostList.from_json(json)
# print the JSON string representation of the object
print(ListedPostList.to_json())

# convert the object into a dict
listed_post_list_dict = listed_post_list_instance.to_dict()
# create an instance of ListedPostList from a dict
listed_post_list_from_dict = ListedPostList.from_dict(listed_post_list_dict)
```
