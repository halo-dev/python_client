...
**items** | [**List[ListedPostVo]**](ListedPostVo.md) | A chunk of items. | 
...
json = "{}"
# create an instance of ListedPostVoList from a JSON string
listed_post_vo_list_instance = ListedPostVoList.from_json(json)
# print the JSON string representation of the object
print(ListedPostVoList.to_json())

# convert the object into a dict
listed_post_vo_list_dict = listed_post_vo_list_instance.to_dict()
# create an instance of ListedPostVoList from a dict
listed_post_vo_list_from_dict = ListedPostVoList.from_dict(listed_post_vo_list_dict)
```
