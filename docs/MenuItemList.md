...
**items** | [**List[MenuItem]**](MenuItem.md) | A chunk of items. | 
...
json = "{}"
# create an instance of MenuItemList from a JSON string
menu_item_list_instance = MenuItemList.from_json(json)
# print the JSON string representation of the object
print(MenuItemList.to_json())

# convert the object into a dict
menu_item_list_dict = menu_item_list_instance.to_dict()
# create an instance of MenuItemList from a dict
menu_item_list_from_dict = MenuItemList.from_dict(menu_item_list_dict)
```
