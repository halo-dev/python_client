...
**items** | [**List[Menu]**](Menu.md) | A chunk of items. | 
...
json = "{}"
# create an instance of MenuList from a JSON string
menu_list_instance = MenuList.from_json(json)
# print the JSON string representation of the object
print(MenuList.to_json())

# convert the object into a dict
menu_list_dict = menu_list_instance.to_dict()
# create an instance of MenuList from a dict
menu_list_from_dict = MenuList.from_dict(menu_list_dict)
```
