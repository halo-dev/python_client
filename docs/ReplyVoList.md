...
json = "{}"
# create an instance of ReplyVoList from a JSON string
reply_vo_list_instance = ReplyVoList.from_json(json)
# print the JSON string representation of the object
print(ReplyVoList.to_json())

# convert the object into a dict
reply_vo_list_dict = reply_vo_list_instance.to_dict()
# create an instance of ReplyVoList from a dict
reply_vo_list_from_dict = ReplyVoList.from_dict(reply_vo_list_dict)
```
