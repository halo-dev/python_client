...
**items** | [**List[UserConnection]**](UserConnection.md) | A chunk of items. | 
...
json = "{}"
# create an instance of UserConnectionList from a JSON string
user_connection_list_instance = UserConnectionList.from_json(json)
# print the JSON string representation of the object
print(UserConnectionList.to_json())

# convert the object into a dict
user_connection_list_dict = user_connection_list_instance.to_dict()
# create an instance of UserConnectionList from a dict
user_connection_list_from_dict = UserConnectionList.from_dict(user_connection_list_dict)
```
