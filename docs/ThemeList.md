...
**items** | [**List[Theme]**](Theme.md) | A chunk of items. | 
...
json = "{}"
# create an instance of ThemeList from a JSON string
theme_list_instance = ThemeList.from_json(json)
# print the JSON string representation of the object
print(ThemeList.to_json())

# convert the object into a dict
theme_list_dict = theme_list_instance.to_dict()
# create an instance of ThemeList from a dict
theme_list_from_dict = ThemeList.from_dict(theme_list_dict)
```
