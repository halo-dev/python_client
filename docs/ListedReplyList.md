...
**items** | [**List[ListedReply]**](ListedReply.md) | A chunk of items. | 
...
listed_reply_list_instance = ListedReplyList.from_json(json)
# print the JSON string representation of the object
print(ListedReplyList.to_json())

# convert the object into a dict
listed_reply_list_dict = listed_reply_list_instance.to_dict()
# create an instance of ListedReplyList from a dict
listed_reply_list_from_dict = ListedReplyList.from_dict(listed_reply_list_dict)
```
