...
**items** | [**List[CategoryVo]**](CategoryVo.md) | A chunk of items. | 
...
json = "{}"
# create an instance of CategoryVoList from a JSON string
category_vo_list_instance = CategoryVoList.from_json(json)
# print the JSON string representation of the object
print(CategoryVoList.to_json())

# convert the object into a dict
category_vo_list_dict = category_vo_list_instance.to_dict()
# create an instance of CategoryVoList from a dict
category_vo_list_from_dict = CategoryVoList.from_dict(category_vo_list_dict)
```
